                    ...
                    <form method="post" action="assets/check_avail_home.php" id="check_avail_home" autocomplete="off">
                        <div id="group_1">
                            <div id="container_1">
                                ...
                                <input class="date-pick form-control" type="text" id="check_in" name="check_in" data-date-format="M d, D" placeholder="Arrival" readonly>
                                <span class="input-icon"><i class="icon-calendar-7"></i></span>
                            </div>
                            <div id="container_2">
                                <label>Departure date</label>
                                <input class="date-pick form-control" type="text" id="check_out" name="check_out" data-date-format="M d, D" placeholder="Departure" readonly>
                                <span class="input-icon"><i class="icon-calendar-7"></i></span>
                            </div>
                        </div><!-- End group_1 -->
                        <div id="group_2">
