...
<body>
    ...
    <div id="subheader_home">
        <div id="sub_content">
            <h3 class="caption_header"><strong id="js-rotating">Best,Large,Cousy</strong> accommodations</h3>
                <p><a href="#0" class="btn_slider">Read more</a></p>
             </div><!-- End sub_content -->
    </div><!-- End subheader -->
    </section><!-- End section -->
    <!-- End SubHeader ============================================ -->
    ...
    <div class="container margin_60_35">
        <h2 class="main_title"><em></em>Welcome to Albert <span>Hotel and Bed&amp;Breakfast</span></h2>
        <p class="lead styled">
