    ...
    <div class="container margin_60">
            <div class="col-md-8 col-md-offset-2">
                    ...
                    <!-- Headings & Paragraph Copy -->         
                     ...
                     <div class="panel-group" id="accordion">
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Anim reprehenderit?<i class="indicator icon_set_1_icon-10 pull-right"></i></a>
                          </h4>
                        </div>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Parsnip lotus root celery?<i class="indicator icon_set_1_icon-11 pull-right"></i></a>
                          </h4>
                        </div>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Beet greens peanut salad?<i class="indicator icon_set_1_icon-11 pull-right"></i></a>
                          </h4>
                        </div>
                   ...
                   <div class="row magnific-gallery">
                       <div class="col-md-6">
                            <a href="img/room_detail_1.jpg" title="Photo title"><img src="img/room_detail_1.jpg" alt="" class="img-responsive"></a>
                       </div>
                       <div class="col-md-6">
                            <a href="img/room_detail_2.jpg" title="Photo title"><img src="img/room_detail_2.jpg" alt="" class="img-responsive"></a>
                       </div>
                   </div><!-- End row-->
                   ...
                   <div class="row magnific">
                       <div class="col-md-6">
                            <a href="https://vimeo.com/15306847" class="video" title="Video title"><img src="img/room_detail_3.jpg" alt="" class="img-responsive"></a>
                       </div>
                       <div class="col-md-6">
                            <a href="https://www.youtube.com/watch?v=vasS8dMKzjM"  class="video" title="Video title"><img src="img/room_detail_4.jpg" alt="" class="img-responsive"></a>
                       </div>
                   </div><!-- End row-->
