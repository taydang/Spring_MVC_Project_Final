...
<body>
    ...
    <!-- SubHeader =============================================== -->
    <section class="parallax-window" id="short" data-parallax="scroll" data-image-src="./resources/img/sub_header_short.jpg" data-natural-width="1400" data-natural-height="350">
        <div id="subheader">
    	...
    	<div class="row">
 			<div class="col-lg-9 col-md-8">
            	<div class="row">
                	...
                	<div class="room_desc clearfix" onclick="location.href='room_detail';">
                	<div class="col-md-7">
                    	<figure><img src="./resources/img/room_list_1.jpg" alt="" class="img-responsive"></figure>
                    </div>
                ...
                <div class="row">
                	<div class="room_desc clearfix wow fadeIn" onclick="location.href='room_detail.jsp';" data-wow-delay="0.1s">
                	<div class="col-md-7">
                    	<figure><img src="./resources/img/room_list_2.jpg" alt="" class="img-responsive"></figure>
                    </div>
                    <div class="col-md-5 room_list_desc">
                    	<h3>Double Room</h3>
                        <p>Id tale utinam ius, an mei omnium recusabo iracundia. Mea ad postea meliore fuisset.....</p>
                ...
                <div class="row">
                	<div class="room_desc clearfix wow fadeIn" onclick="location.href='room_detail.jsp';" data-wow-delay="0.1s">
                	<div class="col-md-7">
                    	<figure><img src="./resources/img/room_list_3.jpg" alt="" class="img-responsive"></figure>
                    </div>
                    <div class="col-md-5 room_list_desc">
                ...
                <div class="row">
                	<div class="room_desc clearfix wow fadeIn" onclick="location.href='room_detail.jsp';" data-wow-delay="0.1s">
                	<div class="col-md-7">
                    	<figure><img src="./resources/img/room_list_4.jpg" alt="" class="img-responsive"></figure>
                    </div>
                    <div class="col-md-5 room_list_desc">
                    	<h3>Suite Room</h3>
                        <p>Id tale utinam ius, an mei omnium recusabo iracundia. Mea ad postea meliore fuisset.....</p>
