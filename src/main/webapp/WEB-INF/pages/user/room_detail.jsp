<!DOCTYPE html>
<!--[if IE 9]><jsp class="ie ie9"> <![endif]-->
<html>
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="./resources/css/owl.theme.default.css">
    
    <!--[if lt IE 9]>
      <script src="./resources/js/jsp5shiv.min.js"></script>
                ...
                <a href="#" class="open_close" id="close_in"><i class="icon_set_1_icon-77"></i></a>
                 <ul>
                    ...
                    <ul>
                        ...
                        <li><a href="index_5.jsp">Home Booking date 2</a></li>
                        <li><a href="index_4.jsp">Home Carousel</a></li>
                        <li><a href="index_2.jsp">Home Layer Slider</a></li>
                        <li><a href="index_6.jsp">Home Video bg</a></li>
                        <li><a href="index_3.jsp">Home Text Rotator</a></li>
                    </ul>
                    </li>
                    ...
                    <ul>
                    	<li><a href="header_2/index.jsp">Header transparent</a></li>
                    	<li><a href="room_detail.jsp">Room detail</a></li>
                        <li><a href="room_detail_2.jsp">Room detail date 2</a></li>
                        <li><a href="about.jsp">About us</a></li>
                        <li><a href="faq.jsp">Faq</a></li>
                        <li><a href="gallery.jsp">Gallery</a></li>
                        <li><a href="blog.jsp">Blog</a></li>
                        <li><a href="coming_soon/index.jsp">Site launch/Coming soon</a></li>
                        <li><a href="shortcodes.jsp">Shortcodes</a></li>
                        <li><a href="icon_pack_1.jsp">Icon pack 1</a></li>
                         <li><a href="icon_pack_2.jsp">Icon pack 2</a></li>
                        <li><a href="icon_pack_3.jsp">Icon pack 3</a></li>
                    </ul>
                    </li>
...
<div class="carousel_in">
      <div><img src="./resources/img/room_detail_1.jpg" alt=""><div class="caption"><h3>Fantastic bed room</h3></div></div>
      <div><img src="./resources/img/room_detail_2.jpg" alt=""><div class="caption"><h3>Equiped bathroom</h3></div></div>
      <div><img src="./resources/img/room_detail_3.jpg" alt=""><div class="caption"><h3>Equiped bathroom</h3></div></div>
      <div><img src="./resources/img/room_detail_4.jpg" alt=""><div class="caption"><h3>Nice outdoor</h3></div></div>
      <div><img src="./resources/img/room_detail_5.jpg" alt=""><div class="caption"><h3>Swimming pool</h3></div></div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="review_strip_single">
                        <img src="./resources/img/avatar1.jpg" alt="" class="img-circle">
                    ...
                    <div class="review_strip_single">
                        <img src="./resources/img/avatar2.jpg" alt="" class="img-circle">
                        <small> - 10 March 2015 -</small>
                        <h4>Jhon Doe</h4>
                        <p>
                             "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a lorem quis neque interdum consequat ut sed sem. Duis quis tempor nunc. Interdum et malesuada fames ac ante ipsum primis in faucibus."
                    ...
                    <div class="review_strip_single last">
                        <img src="./resources/img/avatar3.jpg" alt="" class="img-circle">
                        <small> - 10 March 2015 -</small>
                        <h4>Jhon Doe</h4>
                        <p>
                             "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a lorem quis neque interdum consequat ut sed sem. Duis quis tempor nunc. Interdum et malesuada fames ac ante ipsum primis in faucibus."
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <img src="./resources/img/logo_footer.png" width="141" height="40" alt="" id="logo_footer" data-retina="true">
